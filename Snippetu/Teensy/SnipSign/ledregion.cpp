...
void LedRegion::nextFrame(vector<PixelUpdate> &matrixUpdate)
{
    ...
    const uint16_t regionUpperCount = 123;
    ...
    const uint16_t regionLaserCount = 68;
    const uint16_t regionLaser[regionLaserCount] = {66, 68, 65, 63, 61, 70, 423, 112, 75, 76, 77, 59, 57, 55, 426, 111, 109, 78, 80, 54, 52, 50, 429, 467, 107, 105, 103, 106, 83, 85, 48, 46, 469, 471, 101, 99, 88, 44, 42, 472, 474, 476, 478, 97, 95, 91, 93, 34, 35, 36, 39, 37, 7, 6, 5, 4, 3, 2, 1, 0, 17, 18, 19, 20, 21, 22, 23, 24};
